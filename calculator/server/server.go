...
import (
	...
	"github.com/khiem20tc/grpc-go-example/calculator/calculator"
	calculatorpb "github.com/khiem20tc/grpc-go-example/calculator/calculator"
...
func (*server) Square(ctx context.Context, req *calculator.SquareRequest) (*calculatorpb.SquareResponse, error) {
